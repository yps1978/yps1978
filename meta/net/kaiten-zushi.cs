...
namespace net
{
    class ProgramA
    {
        ...
        {
            var a = new ProgramA();
            Console.WriteLine(a.getMaximumEatenDishCount(6, new[] {1, 2, 3, 3, 2, 1}, 1));
            Console.WriteLine(a.getMaximumEatenDishCount(6, new[] {1, 2, 3, 3, 2, 1}, 2));
            Console.WriteLine(a.getMaximumEatenDishCount(7, new[] {1, 2, 1, 2, 1, 2, 1}, 2));

            Console.WriteLine(a.getMaximumEatenDishCount(3, new[] {1, 1, 1}, 1));
        }
